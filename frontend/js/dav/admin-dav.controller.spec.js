...
describe('The adminDavController', function() {
  ...
  function initController(scope) {
    ...
    var controller = $controller('adminDavController', { $scope: $scope });
  ...
  it('should get DAV configuration from server on init', function() {
