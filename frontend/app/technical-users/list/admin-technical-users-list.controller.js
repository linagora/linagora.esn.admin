    ...
    .controller('adminTechnicalUsersListController', function(
      ...
      ADMIN_TECHNICAL_USERS_EVENTS
        ...
        function showUpdateModal(technicalUser) {
          $modal({
            templateUrl: '/admin/app/technical-users/update/admin-technical-users-update.html',
            backdrop: 'static',
            placement: 'center',
            controllerAs: '$ctrl',
        ...
        function showRemoveModal(technicalUser) {
          $modal({
            templateUrl: '/admin/app/technical-users/remove/admin-technical-users-remove.html',
            backdrop: 'static',
            placement: 'center',
            controllerAs: '$ctrl',
